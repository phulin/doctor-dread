...
/* harmony import */ var _dungeon_carriageman__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new _command__WEBPACK_IMPORTED_MODULE_1__/* .Command */ .m("carriage", "dr carriage: Feed carriageman booze.", () => {
  var sheets = (0,_dungeon_carriageman__WEBPACK_IMPORTED_MODULE_2__/* .feedCarriageman */ .j)();

  if (sheets >= 2000) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Success! Fed carriageman to ".concat(sheets, "."), "blue");
  } else {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Failure: carriageman only fed to ".concat(sheets, ". Try picking up some more ACC drinks?"), "red");
  }
}));
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 3827);
