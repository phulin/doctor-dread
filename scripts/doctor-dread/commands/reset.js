...
/* harmony import */ var _dungeon_carriageman__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(49);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new _command__WEBPACK_IMPORTED_MODULE_1__/* .Command */ .m("reset", "dr reset: Reset current clan.", () => {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("clan_basement.php").includes("Acquired by:")) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Can't reset with remaining loot.", "red");
    return;
  }

  if (!(0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("dr_clans", "").split("|").includes((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getClanName)())) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Clan is not in dr_clans.", "red");
    return;
  }

  var stashPage = (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("clan_stash.php");
  var match = stashPage.match(/contains ([0-9,]+) Meat/);

  if (!match) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Couldn't access clan stash page.", "red");
    return;
  }
  ...
  var monstersKilled = (0,libram__WEBPACK_IMPORTED_MODULE_2__.sum)((0,_dungeon_raidlog__WEBPACK_IMPORTED_MODULE_3__/* .dreadKilled */ .SJ)(), _ref => {
    var _ref2 = _slicedToArray(_ref, 2),
        count = _ref2[1];

    return count;
  });
  var freddies = (0,libram__WEBPACK_IMPORTED_MODULE_2__.sum)(_dungeon_raidlog__WEBPACK_IMPORTED_MODULE_3__/* .dreadZones */ .e5, zone => (0,libram__WEBPACK_IMPORTED_MODULE_2__.sum)(zone.subnoncombats(), subnoncombat => (0,libram__WEBPACK_IMPORTED_MODULE_2__.sum)(_toConsumableArray(subnoncombat.choices), _ref3 => {
    var _ref4 = _slicedToArray(_ref3, 2),
        choice = _ref4[1];

    return choice.item === (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject || (_templateObject = _taggedTemplateLiteral(["Freddy Kruegerand"]))) ? choice.count() : 0;
  })));

  if (!(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.userConfirm)("Reset clan ".concat((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getClanName)(), "? Current status:\n") + "".concat(monstersKilled, " monsters killed.\n") + "".concat(freddies, " instances of players collecting freddies."))) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Reset cancelled.", "red");
    return;
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Reopening Dreadsylvania!");

  if (!libram__WEBPACK_IMPORTED_MODULE_2__.Dreadsylvania.close()) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Failed to close Dreadsylvania.", "red");
    return;
  }

  if (!libram__WEBPACK_IMPORTED_MODULE_2__.Dreadsylvania.open()) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Failed to open Dreadsylvania.", "red");
    return;
  }

  if ((0,_dungeon_carriageman__WEBPACK_IMPORTED_MODULE_4__/* .feedCarriageman */ .j)() < 2000) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("Failed to feed carriageman enough booze. Try using 'dreaddrunk castle'.");
  }
}));
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "j": () => (/* binding */ feedCarriageman)
/* harmony export */ });
/* unused harmony export carriagemanSheets */
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7530);
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(kolmafia__WEBPACK_IMPORTED_MODULE_0__);
...
var advancedCocktails = [].concat(_toConsumableArray((0,libram__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject || (_templateObject = _taggedTemplateLiteral(["pink pony, slip 'n' slide, fuzzbump, ocean motion, ducha de oro"])))), _toConsumableArray((0,libram__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["horizontal tango, roll in the hay, a little sump'm sump'm"])))), _toConsumableArray((0,libram__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["slap and tickle, rockin' wagon, perpendicular hula, calle de miel"])))));
var carriagemanBooze = [].concat(_toConsumableArray(advancedCocktails), [(0,libram__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["open sauce"])))]);
function carriagemanSheets() {
  var pageText = (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("clan_dreadsylvania.php?place=carriage");
  var match = pageText.match(/The carriageman is currently ([0-9,]+) sheets to the wind/);
...
function feedCarriageman() {
  var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2000;
  var sheets;
...
// UNUSED EXPORTS: DreadChoice, DreadNoncombat, DreadSubnoncombat, DreadZone, dreadBanished, dreadElements, dreadMonsters, dreadNoncombatsUsed, dreadZone, dreadZoneTypes, isDreadElementId, isDreadMonsterId, isDreadZoneId, memoizedRaidlog, monsterPair, monsterSingular, monsterZone, raidlogBlocks, toDreadElementId, toElement
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 4001);
