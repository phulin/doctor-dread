...
/* harmony export */ });
/* unused harmony exports withMacro, mapMonster, adventureMacroAuto, main */
...
// UNUSED EXPORTS: DreadChoice, DreadNoncombat, DreadSubnoncombat, DreadZone, dreadElements, dreadMonsters, dreadNoncombatsUsed, dreadZone, dreadZoneTypes, dreadZones, isDreadElementId, isDreadMonsterId, isDreadZoneId, memoizedRaidlog, monsterPair, monsterSingular, monsterZone, raidlogBlocks, toDreadElementId, toElement
...
// UNUSED EXPORTS: BonusEquipMode, Requirement, argmax, baseMeat, cheaper, clamp, clans, coinmasterPrice, determineDraggableZoneAndEnsureAccess, draggableFight, ensureEffect, entries, fairyMultiplier, fromEntries, gnomeWeightValue, kramcoGuaranteed, leprechaunMultiplier, mapMonster, questStep, safeInterrupt, saleValue, setChoice, setDefaultChoiceHandling, sum, tryFeast, withWineglass
...
function testZoneAndUsePotionToAccess() {
  ...
  if (myPath() === "Two Crazy Random Summer") {
    ...
    blacklist.concat($locations(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["Domed City of Grimacia, Domed City of Ronaldus, Hamburglaris Shield Generator, The Red Queen's Garden, The Mouldering Mansion, The Rogue Windmill, The Stately Pleasure Dome"]))));
  }
...
function testZoneForBackups(location) {
  var backupBlacklist = $locations(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["The Overgrown Lot, The Skeleton Store, The Mansion of Dr. Weirdeaux"])));
  return !backupBlacklist.includes(location) && location.combatPercent >= 100;
}

function testZoneForWanderers(location) {
  var wandererBlacklist = $locations(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["The Batrat and Ratbat Burrow, Guano Junction, The Beanbat Chamber"])));
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 4848);
