...
export function main(): void {
  ...
  const settings = [];
  const lines = fileToArray("dr_settings.txt");
  ...
  writeln('<head><link rel="stylesheet" href="/doctor-dread/main.css"></head>');
  ...
  writeln('<script src="./doctor-dread/doctor-dread.js"></script>');
}
